...
class Amodal(BaseDetector, RPNTestMixin):
    ...
    def init_weights(self, pretrained=None):
        super(Amodal, self).init_weights(pretrained)
    ...
    def forward_dummy(self, img):
        raise NotImplementedError("forward_dummy")
        outs = ()
        # backbone
                ...
                for j in range(num_imgs):
                    ...
                    if i != self.num_stages - 1:  # first several stages
                        ...
                        sampling_result_bbox = bbox_sampler.sample(
                            ...
                            gt_labels[j],
                            feats=[lvl_feat[j][None] for lvl_feat in x])
                    sampling_results.append(sampling_result_bbox)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(Amodal, self).show_result(data, result, **kwargs)
